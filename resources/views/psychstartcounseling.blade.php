...
<div class="containerpsychcounsel">
...
<div class="modal fade patient-ecounseling" tabindex="-1" role="dialog" aria-labelledby="patientEcounselingLabel" aria-hidden="true">
  <div class="modalvideo modal-dialog modal-lg">
    <div class="modal-content">
     <div class="vidcontainer">
      ...
      <div class="boxpsych">
          ...
          <div class="videocardpsych card mb3 h-100">
          ...
          <div class="col-md-4">
                 ...
                 <div class="forvidnotes form-group">
                  {{Form::label('about', 'Session Notes')}}
                 {{Form::textarea('sesnotes', '',['class' => 'form-control' , 'style' => 'height: 500px'])}}
                 {{Form::submit('Save Notes', ['class' => 'savenotes btn btn-primary', 'style' => 'float:right; margin-top:15px;'])}} 
             </div> 
           {!! Form::close() !!}
