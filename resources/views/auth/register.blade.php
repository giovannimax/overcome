...
<div class="container">
    <div class="row " >
        <div class="col-md-8 col-md-offset-2">
            <div class="panel  panellregister">
                <div class="panel-heading text-center" ><h3 style="color:#dcdbdb;margin-bottom: -15px;">Register</h3></div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal register-form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required  style="margin-bottom: 25px;">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="password" required  style="margin-bottom: 25px;">
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label" style="color:#dcdbdb;">Retype Password</label>

                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required  style="margin-bottom: 25px;">
                            </div>
                        </div>

                        <div class="form-group ">
                            <div class="col-md-6 col-md-offset-4 text-right" style="margin-bottom: 50px;">
                                <button type="submit" class="btn btn-primary btnreg">
                                    Sign up
                                </button>
                            </div>
                        </div>
