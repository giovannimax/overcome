...
<div class="form-group">
   ...
   <div class="col-md-4"> {{ Form::radio('pat_gndr', 'male'),  'required' }} Male </div>
   <div class="col-md-4">{{ Form::radio('pat_gndr', 'female') }} Female </div>
    </div>
    </div>
<div class="form-group">
    {{ Form::label('Birthday') }}
    {{ Form::date('pat_bdate', \Carbon\Carbon::now(), ['class' => 'form-control']) }}
</div>  
